...
public class FavAudioAdapter extends RecyclerView.Adapter<FavAudioAdapter.FavAudioHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public FavAudioHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavAudioHolder holder, int position) {
        Audio audio = mListAudio.get(position);
        if (audio == null) {
            return;
        }
